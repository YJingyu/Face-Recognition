...
x_train = np.zeros([3000, 200, 200, 3])
y_train = np.zeros([3000, 200, 200, 1])
x_test = x_train[2276: ]
y_test = y_train[2276: ]
...
for epoch in range(EPOCHS):
	...
	IOU_Train *= 100.0
	IOU_Test *= 100.0
	print('Epoch: {:5d}\tLoss: {:5f}\tTrain-IOU: {:5f}%\tTest-IOU: {:5f}%'.format(epoch, loss, IOU_Train, IOU_Test))
	random_indices_train = random.sample(range(0, np.shape(x_train)[0]), 3)
	random_indices_test = random.sample(range(0, np.shape(x_test)[0]), 3)
