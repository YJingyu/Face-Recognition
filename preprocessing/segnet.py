class segnet:
	def __init__(self):
		...
		self.conv5 = tf.nn.conv2d(self.upsample4, self.wconv5, strides = [1, 1, 1, 1], padding ='SAME')
		...
		self.conv6 = tf.nn.conv2d(self.upsample5, self.wconv6, strides = [1, 1, 1, 1], padding = 'SAME')
		...
		self.conv8 = tf.nn.conv2d(self.upsample7, self.wconv8, strides = [1, 1, 1, 1], padding = 'SAME')
